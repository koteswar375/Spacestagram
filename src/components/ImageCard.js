...
class ImageCard extends Component {
    ...
    handleClick = () => {
        const likeState = !this.state.like;
    ...
    render() {
        const { url, date, title, description } = this.props.image;
        ...
        return (
            <div className="bg-light border border-secondary mt-2 " style={{ width: '300px', gridRowEnd: `span ${this.state.spans}` }}>
                ...
                <div ref={this.bodyRef} className="px-2 py-2" style={{ cursor: 'pointer' }}>
                    ...
                    <p className="text-wrap mt-1" style={{ textAlign: 'justify' }}><small>{description}</small></p>
                    <button onClick={this.handleClick.bind(this)} className={`btn btn-sm ${this.state.like ? "btn-primary" : "btn-light"} d-flex align-items-center`}>
                        <div>Like</div>
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" style={{ lineHeight: 16 }} className="bi bi-hand-thumbs-up" viewBox="0 0 16 16">
